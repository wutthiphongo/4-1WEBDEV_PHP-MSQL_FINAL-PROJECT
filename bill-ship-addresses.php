	...
	<!-- panel-heading -->
    	...
    	<h4 class="unicase-checkout-title">
	        <a data-toggle="collapse" class="" data-parent="#accordion" href="#collapseOne">
	          <span>1</span>ที่อยู่เรียกเก็บเงิน
	        </a>
	     </h4>
    </div>
    <!-- panel-heading -->
...
<div class="form-group">
					    <label class="info-title" for="Billing Address"> บ้านเลขที่ <span>*</span></label>
						    ...
						    <div class="panel-heading">
						      <h4 class="unicase-checkout-title">
						        <a data-toggle="collapse" class="collapsed" data-parent="#accordion" href="#collapseTwo">
						          <span>2</span>ที่อยู่สำหรับจัดส่ง
						        </a>
						      </h4>
						    </div>
...
?>
					...
					<form class="register-form" role="form" method="post">
<div class="form-group">
					    <label class="info-title" for="Shipping Address">บ้านเลขที่<span>*</span></label>
