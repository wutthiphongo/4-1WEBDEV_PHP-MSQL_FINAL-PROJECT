...
<html lang="en">
	<head>
	    ...
	    <title>TONG-INTER | ลืมรหัสผ่าน</title>
...
?>
		...
		<div class="form-group">
		    <label class="info-title" for="exampleInputEmail1">ที่อยู่อีเมล <span>*</span></label>
		    <input type="email" name="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" required >
		</div>
	  	<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">เบอร์โทรติดต่อ <span>*</span></label>
...
<div class="form-group">
	  	...
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="change">เปลี่ยนรหัสผ่าน</button>
	</form>					
</div>
<!-- Sign-in -->
