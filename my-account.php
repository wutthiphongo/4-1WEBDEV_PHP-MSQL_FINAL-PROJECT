...
<div class="form-group">
					    <label class="info-title" for="name">ชื่อ<span>*</span></label>
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Contact No.">เบอร์โทรศัพท์<span>*</span></label>
...
<div class="form-group">
					    <label class="info-title" for="Current Password">รหัสผ่านปัจจุบัน<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="New Password">รหัสผ่านใหม่<span>*</span></label>
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="Confirm Password">ยืนยันรหัสผ่าน<span>*</span></label>
					    <input type="password" class="form-control unicase-form-control text-input" id="cnfpass" name="cnfpass" required="required" >
					  </div>
					  <button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">เปลี่ยนรหัสผ่าน</button>
					</form> 
