...
if(!empty($_SESSION['cart'])){
	?>
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item">ลบทิ้ง</th>
					<th class="cart-description item">รูป</th>
					<th class="cart-product-name item">ชื่อสินค้า</th>
			
					<th class="cart-qty item">จำนวน</th>
					<th class="cart-sub-total item">ราคาต่อชิ้น</th>
					<th class="cart-sub-total item">ค่าส่ง</th>
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">เลือกซื้อสินค้าต่อ</a>
...
?>
								<div class="reviews">
									( <?php echo htmlentities($num);?> รีวิว )
								</div>
								<?php } ?>
							</div>
						</div><!-- /.row -->
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "บาท"." ".$row['productPrice']; ?>.00</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "บาท"." ".$row['shippingCharge']; ?>.00</span></td>
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">ที่อยู่สำหรับจัดส่ง</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">ที่อยู่สำหรับจัดส่งเรียกเก็บเงิน<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">จังหวัด  <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">เขต/อำเภอ <span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">รหัสไปรษณีย์ <span>*</span></label>
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button">อัพเดตข้อมูล</button>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">ที่อยู่สำหรับจัดส่งเรียกเก็บเงิน</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
					    <label class="info-title" for="Shipping Address">ที่อยู่สำหรับจัดส่ง<span>*</span></label>
			 ...
			 <input type="text" class="form-control unicase-form-control text-input" id="shippingstate" name="shippingstate" value="<?php echo $row['shippingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">อำเภอ/เขต <span>*</span></label>
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="shipupdate" class="btn-upper btn btn-primary checkout-page-button">อัพเดตข้อมูล</button>
					<?php } ?>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						ผลรวม<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">ดำเนินการสั่งซื้อ</button>
