...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			<thead>
				<tr>
					<th colspan="4">สินค้าที่คุณชื่นชอบ</th>
				</tr>
			</thead>
			<tbody>
<?php
...
?>
						...
						<div class="rating">
							...
							<span class="review">( <?php echo htmlentities($num);?> รีวิว )</span>
						</div>
						<?php } ?>
						<div class="price"> 
							<?php echo htmlentities($row['pprice']);?>บาท
							<span>$900.00</span>
						</div>
					</td>
					<td class="col-md-2">
						<a href="my-wishlist.php?page=product&action=add&id=<?php echo $row['pid']; ?>" class="btn-upper btn btn-primary">เพิ่มลงตะกร้าสินค้า</a>
					</td>
				...
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">ยังไม่มีสิ่งที่คุณชื่นชอบ</td>
