		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total item">ราคารวม</th>
					<th class="cart-total item">วิธีการชำระเงิน</th>
					<th class="cart-description item">วันที่สั่งซื้อ</th>
...
<?php $cnt=$cnt+1;} } else { ?>
				<tr><td colspan="8">รหัสคำสั่งซื้อหรือ รหัสอีเมลที่ลงทะเบียนไม่ถูกต้อง</td></tr>
				<?php } ?>
			</tbody><!-- /tbody -->
		</table><!-- /table -->
