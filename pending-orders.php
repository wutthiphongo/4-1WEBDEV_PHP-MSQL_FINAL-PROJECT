		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total">ราคารวม</th>
					<th class="cart-total item">วิธีการชำระเงิน</th>
					<th class="cart-description item">วันที่</th>
...
?>
				<tr>
					...
					<td><a href="pending-orders.php?id=<?php echo $row['oid']; ?> ">ลบทิ้ง</td>
				</tr>
<?php $cnt=$cnt+1;} ?>
<tr>
	<td colspan="9"><div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary"><a href="payment-method.php">ดำเนินการสั่งซื้อ</a></button>
...
<?php } else {?>
<tr>
<td colspan="10" align="center"><h4>ไม่พบผลลัพธ์</h4></td>
</tr>
<?php } ?>
