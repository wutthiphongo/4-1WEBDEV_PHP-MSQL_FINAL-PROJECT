...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	<h3 class="section-title">หมวดหมู่</h3>
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									 <?php echo htmlentities($rws['productPrice']);?> Baht 
								</span>
									
							     <span class="price-before-discount"><?php echo htmlentities($row['productPriceBeforeDiscount']);?> Baht</span>					
						...
						<div class="cart clearfix animate-effect">
							...
							<button class="btn btn-primary" type="button">เพิ่มลงตะกร้าสินค้า</button></a>
								<?php } else {?>
							<div class="action" style="color:red">สินค้าหมด</div>
					<?php } ?>
...
?>		
							<div class="rating-reviews m-t-20">
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="reviews">
											<a href="#" class="lnk">(<?php echo htmlentities($num);?> รีวิว)</a>
										</div>
									</div>
								</div><!-- /.row -->		
							</div><!-- /.rating-reviews -->
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label"> แบรนด์สินค้า :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											 <span class="price"> <?php echo htmlentities($row['productPrice']);?> Baht </span>
											  <span class="price-strike"><?php echo htmlentities($row['productPriceBeforeDiscount']);?> Baht </span>
										</div>
									</div>
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> เพิ่มลงตะกร้าสินค้า</a>
													<?php } else {?>
							<div class="action" style="color:red">สินค้าหมด</div>
					<?php } ?>
									</div>
							...
							<div class="product-social-link m-t-20 text-right">
								<span class="social-label">แชร์ :</span>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								...
								<li><a data-toggle="tab" href="#review">รีวิว</a></li>
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											<h4 class="title">รีวิวโดย ผู้ซื้อ</h4>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>คุณภาพสินค้า :</b>  <?php echo htmlentities($rvw['quality']);?> ดาว</div>
													<div class="text"><b>ราคาสินค้า :</b>  <?php echo htmlentities($rvw['price']);?> ดาว</div>
													<div class="text"><b>ความคุ้มค่า :</b>  <?php echo htmlentities($rvw['value']);?> ดาว</div>
										...
										<div class="product-add-review">
											<h4 class="title">แสดงความคิดเห็น/รีวิวสินค้าของคุณ</h4>
											<div class="review-table">
												<div class="table-responsive">
													<table class="table table-bordered">	
														...
														<tbody>
															<tr>
																<td class="cell-label">คุณภาพสินค้า</td>
															...
															<tr>
																<td class="cell-label">ราคาสินค้า</td>
															...
															<tr>
																<td class="cell-label">ความคุ้มค่า</td>
												...
												<div class="form-container">
														...
														<div class="row">
															<div class="col-sm-6">
																...
																<div class="form-group">
																	<label for="exampleInputSummary">สรุป <span class="astk">*</span></label>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview">รีวิว <span class="astk">*</span></label>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
														...
														<div class="action text-right">
															<button name="submit" class="btn btn-primary btn-upper">ส่งความคิดเห็น/รีวิว</button>
														</div><!-- /.action -->
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					 <?php echo htmlentities($rw['productPrice']);?> บาท </span>
										     <span class="price-before-discount">
										      <?php echo htmlentities($rw['productPriceBeforeDiscount']);?> บาท </span>
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">เพิ่มลงตะกร้าสินค้า</a>
