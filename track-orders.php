	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>ติดตามคำสั่งซื้อของคุณ</li>
			</ul>
...
<div class="body-content outer-top-bd">
	<div class="container">
		<div class="track-order-page inner-bottom-sm">
			<div class="row">
				<div class="col-md-12">
	<h2>ติดตามคำสั่งซื้อของคุณ</h2>
	<span class="title-tag inner-top-vs">ป้อน ID คำสั่งซื้อของคุณ (Order ID) ในช่องด้านล่างและกด Enter เราจะมอบใบเสร็จรับเงินให้คุณผ่านในอีเมลที่ยืนยัน</span>
	<form class="register-form outer-top-xs" role="form" method="post" action="order-details.php">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label class="info-title" for="exampleBillingEmail1">อีเมลที่ลงทะเบียน</label>
		    <input type="email" class="form-control unicase-form-control text-input" name="email" id="exampleBillingEmail1" >
		</div>
	  	<button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">ติดตาม</button>
	</form>	
</div>			</div><!-- /.row -->
		</div><!-- /.sigin-in-->
		<!-- ============================================== BRANDS CAROUSEL ============================================== -->
